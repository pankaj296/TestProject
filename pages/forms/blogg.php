              ...
              <form method="POST" enctype="multipart/form-data"> 
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="btitle" id="btitle" rows="2" placeholder="Enter ..."></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Blogs Details </label>
                    <textarea class="form-control" name="bdetail" id="bdetail" rows="3" placeholder="Enter ..."></textarea>
...
function submitrec(){
  ...
  $('form').ajaxForm({
		type:"POST",
		url:"i_addblogs.php",
		data:{btitle:$("#btitle").val(),bdesc:$("#bdetail").val()},
		    success:function(response){
					},
